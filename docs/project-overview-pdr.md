...
Dreams is a curated, swipeable Jetpack Compose gallery for learning **Android Graphics Shading Language (AGSL)** through 61 bite-sized lessons organized by topic, plus four full-screen "wow" showcase demos engineered for screen-recording.
...
| **Target SDK** | 36 |
| **Lessons** | 61 educational lessons across 10 categories |
| **Showcases** | 4 (Ripple on Tap, Codex Splash, Warp Voyage, Liquid Chrome) |
...
- Lesson bootstrap (65 lessons + metadata) completes in <500ms
...
- **Why:** LessonRegistry.bootstrap() checks `if (all.isEmpty())` before loading 65 lessons; safe for test restarts
...
- All 65 lessons load and render without crashes
...
- [x] All 65 lessons load and render
